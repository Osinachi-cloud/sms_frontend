...
const DEFAULT_TEMPLATES: Record<EntityType, { label: string; icon: typeof Users; description: string; fields: TemplateField[] }> = {
  students: {
    label: 'Students',
    icon: Users,
    description: 'Upload multiple students with optional parent/guardian details. Students can use email or username. Password is auto-generated if blank.',
    fields: [
      { key: 'full_name', label: 'Full Name', required: true, example: 'Ade Johnson', description: 'Student full name' },
      { key: 'email', label: 'Email', required: false, example: 'cstemagic@gmail.com', description: 'Valid email address (use this or username)' },
      { key: 'username', label: 'Username', required: false, example: 'ade_johnson', description: 'Username with at least one special character (@$!%*?&._-). Use if student has no email.' },
      { key: 'phone', label: 'Phone', required: true, example: '+2348167144768', description: 'Phone with country code' },
      ...
      { key: 'address', label: 'Address', required: true, example: '[STREET_ADDRESS_REDACTED]', description: 'Residential address' },
      ...
      { key: 'parent_email', label: 'Parent Email', required: false, example: 'cstemagic@gmail.com', description: 'Parent email address. If provided, a parent user account is created automatically' },
      { key: 'parent_phone', label: 'Parent Phone', required: false, example: '+2348167144768', description: 'Parent phone number' },
