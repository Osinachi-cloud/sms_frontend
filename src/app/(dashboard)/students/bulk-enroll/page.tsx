...
const DEFAULT_TEMPLATES: Record<EntityType, { label: string; icon: typeof Users; description: string; fields: TemplateField[] }> = {
  students: {
    ...
    fields: [
      ...
      { key: 'email', label: 'Email', required: false, example: '[EMAIL_REDACTED]', description: 'Valid email address (use this or username)' },
      ...
      { key: 'phone', label: 'Phone', required: true, example: '[PHONE NUMBER_REDACTED]', description: 'Phone with country code' },
